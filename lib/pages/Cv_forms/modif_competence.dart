...
class Modif_competence extends StatefulWidget {
  const Modif_competence({super.key});

  @override
  State<Modif_competence> createState() => _Modif_competenceState();
}

class _Modif_competenceState extends State<Modif_competence> {
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  decoration: InputDecoration(
                                      ...
                                      hintText:
                                          "Entrez le nom de la compétence",
